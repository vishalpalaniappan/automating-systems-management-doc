...
\subsubsection{Deterministic Learning through Automated Failure Diagnosis}
...
\begin{figure}[htbp]
    ...
    \caption{Establish necessary meaning by answering meaningful questions through semantic reasoning.}
    \label{fig:reasoning_loop}
\end{figure}
