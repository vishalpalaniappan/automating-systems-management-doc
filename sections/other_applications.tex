...
\subsection{DCS Compression for Archiving using Custom Specification}

Since CLP will be transformed into a domain specific compression engine using this framework. It can also be extended into a compression engine for optimally compressing any dataset. In this process, the compression specification for the data can be provided.
