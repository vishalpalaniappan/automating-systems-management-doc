...
Now that software systems are defined at the level of meaning using the semantic toolkit and are automatically synthesized as an implementation, the same principles apply. If two software systems share the same meaning, they will not misunderstand each other. Another way of saying this is that the system is debugged by constructing it with shared meaning. 
