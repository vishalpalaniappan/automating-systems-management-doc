...
Since the design is an unambiguous structure, it isn't necessarsy to preserve all the execution information to be able to replay it. The design itself can identify the information that can't be deterministically computed by the design. This means that the synthesized implementation can be automaticaly synthesized to only include the non-deterministic information.
