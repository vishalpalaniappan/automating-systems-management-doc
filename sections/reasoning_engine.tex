...
In this process, building the design itself becomes an automated reasoning process, where the meaning is used to automatically construct the world and the engine identifies the missing meaning that prevents internal consistency. Through this feedback loop, the meaning keep getting refined until the design is internally consistent. Through this process, the development of software systems becomes automated because the meaning is automatically realized as an implementation.
